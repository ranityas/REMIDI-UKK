...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="" name="id_petugas" value="<?php echo $row['id_petugas']; ?>" >
    </div>
    <div class="form-group">
        <label> NIS</label>
        <input type="text" class="form-control" placeholder="" name="NIS"value="<?php echo $row['NIS']; ?>" >
      </div>
       <div class="form-group">
        <label> tgl_bayar</label>
        <input type="date" class="form-control" placeholder="" name="tgl_bayar"value="<?php echo $row['tgl_bayar']; ?>" >
      </div>
       <div class="form-group">
        <label> jumlah_bayar</label>
        <input type="number" class="form-control" placeholder="" name="jumlah_bayar"value="<?php echo $row['jumlah_bayar']; ?>" >
      </div>
    <br>
